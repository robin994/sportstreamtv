...
public class PlaybackVideoFragment extends VideoSupportFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTransportControlGlue.setTitle(url.getEntry().getTitle());
        mTransportControlGlue.setSubtitle(url.getEntry().getContent());
        mTransportControlGlue.playWhenPrepared();
        playerAdapter.setDataSource(Uri.parse(url.getEntry().getAuthorUrl()));
    }
